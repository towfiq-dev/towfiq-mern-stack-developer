...
// Page-level metadata for the projects route is handled via a separate
// layout or a server wrapper. Add the following metadata object to a
// new file: src/app/navLinks/projects/layout.jsx  (see seo-files folder)
