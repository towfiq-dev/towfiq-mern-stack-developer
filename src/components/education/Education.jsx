...
import { GraduationCap, BookOpen, Award, Calendar, MapPin, Star, TrendingUp } from "lucide-react";
                  ...
                  <div className={`w-full md:w-[46%] ${isRight ? "md:pr-10" : "md:pl-10"}`}>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          <TrendingUp size={14} className={`flex-shrink-0 text-transparent bg-gradient-to-br ${edu.gradient} [background-clip:text]`} />
                          <div>
